...
const CategoryReviews = ({ categoryType }) => {
  ...
  useEffect(() => {
    const fetchReviews = async () => {
      try {
        // Récupérer les avis pour cette catégorie
        const result = await getCategoryReviews(categoryType);
        ...
        if (currentUser) {
          const userReviewResult = await getUserCategoryReview(currentUser.uid, categoryType);
  ...
  const handleSubmitReview = async (e) => {
    ...
    try {
      const reviewData = {
        ...
        categoryType, // Au lieu de productId, nous utilisons categoryType
        rating: newReview.rating,
        title: newReview.title,
        comment: newReview.comment,
        reviewType: 'category' // Pour distinguer des avis de produits
      };
      ...
      if (result.success) {
        ...
        const updatedReviews = await getCategoryReviews(categoryType);
  ...
  return (
    <div className="product-reviews-section" style={{ marginTop: '3rem' }}>
      <div className="reviews-section-header">
        <h2>Avis sur cette catégorie</h2>
      </div>
          ...
          <form className="review-form" onSubmit={handleSubmitReview}>
            ...
            <div className="form-group">
              ...
              <textarea
                ...
                placeholder="Partagez votre expérience avec cette catégorie..."
                rows={5}
                maxLength={1000}
                required
              ></textarea>
